...
private:
    ...
    int DefenseMultiplier = (Card1.DefenseMultiplier + Card2.DefenseMultiplier) / 2;
};
...
// CardMerge ddd(WaterCat, WaterCat, "ddd");
// CardMerge *SHurricaneCat = new CardMerge(WaterCat, WindCat, "Hurricane Cat");
